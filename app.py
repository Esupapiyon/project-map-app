...
DIAGNOSIS_CONTENT = {
    0: { # 甲
        ...
        "desc": "あなたは大樹のように真っ直ぐで、曲がったことが大嫌いな正義の人です。混乱した状況でも一本の道筋を示すことができるリーダーシップを持っており、周囲から「この人についていけば大丈夫」という絶対的な信頼を集めます。ただし、その強さは「折れやすさ」と表裏一体。妥協ができず、一度挫折すると立ち直るのに時間がかかる繊細な一面も持っています。",
        "work": "【プロフェッショナル・経営】\n自分の裁量でルールを決められる環境が最適です。誰かの指示に従うだけの仕事や、曖昧な忖度が求められる組織では窒息します。経営者、専門職、プロジェクトマネージャーなど、責任と権限がセットになったポジションでこそ、その真価を発揮します。",
        "love": "【尊敬と誠実】\n恋愛においても「尊敬できるかどうか」が最重要基準。チャラチャラした相手や、芯のない相手には1ミリも心が動きません。パートナーには、互いに自立し、高め合える対等な関係を求めます。浮気や裏切りは絶対に許さない潔癖さがあります。",
        "fate_code": "Input(論理)→Process(堅実)→Output(熟考)→Drive(自我)\n自分軸が非常に強く、納得しないと動きません。しかし一度決めたらテコでも動かない継続力があります。",
        "desire": "【尊敬・成長】\n金銭よりも「あなたのおかげです」という感謝や、「流石ですね」という称賛がエネルギー源です。",
        "flaw_desc": "融通ゼロ。正論で相手を追い詰め、孤立することがあります。「負けるが勝ち」を覚えましょう。"
    },
    1: { # 乙
        "type_name": "No.2 愛され調整役（THE CONNECTOR）",
        "catch_copy": "したたかに生き残る、\n柔軟な戦略家",
        "desc": "あなたはどんな環境でも、草花のように柔軟に形を変えて生き残るサバイバーです。表立って争うことを避け、笑顔で周囲を調整しながら、いつの間にか自分に有利なポジションを確保する賢さがあります。剛腕リーダーの懐に入り、実質的な決定権を握る「影の支配者」としての才能も秘めています。",
        "work": "【広報・チームビルディング】\n殺伐とした会議を和ませたり、利害関係を調整したりする能力は天才的。広報、人事、秘書、またはコミュニティマネージャーなど、人と人を繋ぐハブとなる仕事が天職です。孤独な作業よりも、チームで成果を出す環境を好みます。",
        "love": "【安心と共有】\n常に誰かと繋がっていたい寂しがり屋。パートナーには、強いリーダーシップで自分を守ってくれる人か、あるいは自分の世話焼きを受け入れてくれる人を求めます。LINEの返信速度や共感の言葉など、目に見える愛情表現を重視します。",
        "fate_code": "Input(感覚)→Process(成長)→Output(衝動)→Drive(協調)\n周囲の空気を読むアンテナが敏感。状況に合わせてカメレオンのように振る舞いを変えられます。",
        "desire": "【調和・安全】\n波風が立たないこと、そして自分が集団から弾き出されないことを最優先します。",
        "flaw_desc": "八方美人すぎて「で、本音は？」と言われがち。依存心が強く、決断を人任せにする癖があります。"
    },
    2: { # 丙
        "type_name": "No.3 天性の主人公（THE PROTAGONIST）",
        "catch_copy": "世界を照らす、\nあくなき挑戦者",
        "desc": "あなたはそこにいるだけでその場がパッと明るくなる、太陽のような存在です。裏表がなく、感情がすべて顔に出るため、誰からも愛されます。「なんとかなる！」という根拠のない自信で突き進み、失敗してもケロっとしているポジティブさは、周囲の人々に勇気を与えます。",
        "work": "【プレゼンター・芸能】\nルーティンワークは死ぬほど退屈します。営業、広報、YouTuber、タレントなど、自分の個性やキャラクターを売り込む仕事が最適。短期集中型で、新しいプロジェクトの立ち上げ期に圧倒的な爆発力を発揮します。",
        "love": "【情熱と称賛】\n恋愛は直感型。「好き！」と思ったら即アプローチします。相手には、自分の話をニコニコ聞いてくれて、常に「すごいね！」と褒めてくれるファン第一号のような存在を求めます。釣った魚に餌をやらない飽きっぽさには注意。",
        "fate_code": "Input(感覚)→Process(成長)→Output(衝動)→Drive(自我)\n思考する前に行動するタイプ。走りながら考えることで、誰よりも早く正解にたどり着きます。",
        "desire": "【注目・称賛】\n自分が見られている、褒められているという実感が、何よりのガソリンになります。",
        "flaw_desc": "「私の話を聞け！」なジャイアン気質。人の話を聞いているようで、次は自分が何を話そうか考えています。"
    },
    3: { # 丁
        "type_name": "No.4 熱き夢想家（THE MUSE）",
        "catch_copy": "静寂に燃える、\n知性の灯火",
        "desc": "あなたは一見穏やかで物静かですが、内側にはドロドロとした情熱や独自の美学、そして反骨精神を秘めています。鋭い洞察力を持ち、誰も気づかないような微細な変化や本質を見抜くことができます。そのミステリアスな雰囲気は、一部の人を強烈に惹きつけるカリスマ性となります。",
        "work": "【クリエイター・参謀】\n感性と知性を融合させる仕事が向いています。デザイナー、ライター、戦略コンサルタントなど、独自の視点で新しい価値を生み出す職種。また、組織のNo.2としてトップに知的な助言を行う参謀役としても優秀です。",
        "love": "【理解と一体感】\n言葉にしなくても通じ合える、深い精神的な繋がりを求めます。表面的な付き合いは苦手で、少数の理解者と濃密な関係を築きます。一度心を許すと非常に一途ですが、裏切りに対しては執念深く恨みを持ち続ける怖さも。",
        "fate_code": "Input(論理)→Process(堅実)→Output(熟考)→Drive(自我)\n感情を論理で武装するタイプ。表には出さないものの、内面では常にシミュレーションを繰り返しています。",
        "desire": "【理解・美学】\n自分の複雑な内面をわかってくれる深い理解者と、自分なりの美学を満たす環境を求めます。",
        "flaw_desc": "察してちゃん界のラスボス。言葉にせず「わかってよ」オーラを出し、勝手に傷つく面倒くさい一面も。"
    },
    4: { # 戊
        "type_name": "No.5 不動の守護神（THE ANCHOR）",
        "catch_copy": "すべてを受け入れる、\n揺るがぬ巨塔",
        "desc": "あなたはちょっとやそっとのことでは動じない、圧倒的な包容力の持ち主です。相談事をされると「うんうん」と聞いているだけで相手を安心させてしまう、人間パワースポット。来るもの拒まずの器の大きさがあり、自然と人やお金が集まってくる「社長・オーナー」気質です。",
        "work": "【管理・バックオフィス】\n変化の激しい現場よりも、どっしりと構えて全体を見渡すポジションが向いています。総務、経理、不動産管理、あるいは店舗オーナーなど。一度築いたシステムや資産を守り、育てる能力に長けています。",
        "love": "【安定と信頼】\n刺激的な恋よりも、穏やかで家庭的な関係を望みます。パートナーには誠実さと、自分のペースを乱さないことを求めます。自分からガツガツ動くのは苦手なので、少し強引に引っ張ってくれる相手との相性が良いでしょう。",
        "fate_code": "Input(論理)→Process(堅実)→Output(熟考)→Drive(協調)\nリスクを嫌い、確実性を重視します。動き出しは遅いですが、一度動き出せばブルドーザーのような推進力を持ちます。",
        "desire": "【安定・信頼】\nリスクを冒すことよりも、盤石な基盤を築き、周囲から頼りにされることを喜びとします。",
        "flaw_desc": "テコでも動かない頑固オヤジ。変化を嫌い、現状維持バイアスがかかりすぎてチャンスを逃すことも。"
    },
    5: { # 己
        "type_name": "No.6 尽くす世話焼き（THE NURTURER）",
        "catch_copy": "才ある者を育む、\n慈愛の大地",
        "desc": "あなたは困っている人を放っておけない、根っからの教育者でありサポーターです。自分自身がトップに立つよりも、他人の才能を見抜き、育て、輝かせることに無上の喜びを感じます。複雑なことをわかりやすく教える能力や、細やかな気配りは組織の接着剤として不可欠です。",
        "work": "【教育・育成】\n教師、インストラクター、カスタマーサクセス、福祉関係など、直接的に人の役に立つ仕事が天職です。また、データの整理や収集など、地味だが重要な作業をコツコツ積み上げることも得意とし、周囲から感謝されます。",
        "love": "【貢献とファミリー】\n「あなたのためなら」と尽くすタイプ。少し頼りない、放っておけない相手を好きになりがちです。家庭的で、結婚後は家族を何よりも大切にする良き夫・良き妻になりますが、過干渉になりすぎないよう注意が必要です。",
        "fate_code": "Input(感覚)→Process(成長)→Output(熟考)→Drive(協調)\n相手の反応を見ながら自分の行動を微調整できる、高い対人知性を持っています。",
        "desire": "【貢献・親密】\n誰かの役に立っているという実感と、ファミリーのようなウェットな人間関係を求めます。",
        "flaw_desc": "尽くしすぎてダメンズ製造機。感謝の見返りがないと「あんなにしてあげたのに」と愚痴っぽくなります。"
    },
    6: { # 庚
        "type_name": "No.7 正義の切り込み隊長（THE HERO）",
        "catch_copy": "時代を切り拓く、\n鋼の革命家",
        "desc": "あなたは「それはおかしい」と声を上げ、古い体制や悪習を一刀両断する改革者です。白黒ハッキリつけないと気が済まない性格で、そのスピード感と決断力は組織の停滞を打破する起爆剤となります。裏表がなくサッパリしているため、敵も多いですが、熱狂的な信者も生まれます。",
        "work": "【改革・プロジェクトリーダー】\n新規事業の立ち上げ、組織改革、外科医、警察官など、正義感とスピード決断が求められる現場。または、エンジニアとしてバグを潰していくような、論理的かつ攻撃的な解決能力を活かせる仕事が向いています。",
        "love": "【直球勝負】\n駆け引きは大の苦手。好きなら好きとはっきり伝えます。パートナーには、自分と同じくらい自立していて、議論ができる知的な相手を求めます。ウジウジ悩む相手にはイライラしてしまうため、メンタルの強い相手が理想です。",
        "fate_code": "Input(論理)→Process(成長)→Output(衝動)→Drive(自我)\n結論ファースト。プロセスよりも結果を重視し、最短距離でゴールを目指す効率主義者です。",
        "desire": "【変革・勝利】\n現状を変えること、競争に勝つこと、そして自分の実力を証明することに快感を覚えます。",
        "flaw_desc": "デリカシー？何それ美味しいの？ 正論というナイフで相手を滅多刺しにしてしまうことがあります。"
    },
    7: { # 辛
        "type_name": "No.8 繊細な宝石（THE IDOL）",
        "catch_copy": "試練を輝きに変える、\n美しきカリスマ",
        "desc": "あなたは生まれながらにして「特別感」を漂わせる、美意識の高い人です。宝石が研磨されて輝くように、人生の試練や苦労を糧にして、人間的な深みや魅力を増していきます。感受性が鋭く、傷つきやすい一面もありますが、その繊細さが独自のセンスや表現力を生み出します。",
        "work": "【スペシャリスト・美の追求】\n泥臭い仕事や、粗雑な環境は耐えられません。美容、ファッション、宝飾、ITエンジニア、精密機器など、細部へのこだわりと美意識が評価される仕事。あるいは「あなたにしかできない」と指名されるようなブランド力を持つ仕事。",
        "love": "【特別扱いと洗練】\n自分を「お姫様・王子様」として扱ってくれる相手でないと続きません。デートの場所やプレゼントのセンスにも厳しく、スマートなエスコートを求めます。しかし、一度愛した相手には深い愛情を注ぎ、自らを磨き続けて魅了し続けます。",
        "fate_code": "Input(感覚)→Process(堅実)→Output(熟考)→Drive(自我)\nこだわりが強く、納得いくまで細部を詰め切る完璧主義者。クオリティに妥協しません。",
        "desire": "【特別感・洗練】\n自分がその他大勢とは違う特別な存在であること、美しいものに囲まれていることを求めます。",
        "flaw_desc": "メンタル強度スライム級のワガママ。プライドが高く、自分から謝るのが死ぬほど嫌いです。"
    },
    8: { # 壬
        "type_name": "No.9 自由な冒険家（THE NOMAD）",
        "catch_copy": "境界を超えて流れる、\n自由の象徴",
        "desc": "あなたは一箇所に留まることができない、永遠の旅人です。スケールが大きく、常に新しい刺激や知識を求めて流動しています。「普通こうだよね」という枠に収まらない発想を持ち、組織に新しい風（トレンドや海外の情報など）を吹き込む「運び屋」として活躍します。",
        "work": "【企画・フリーランス】\nデスクに縛り付けられる仕事は拷問です。商社、貿易、イベント企画、ツアーコンダクター、Webマーケターなど、移動や変化が多い仕事。または、複数の拠点を持ち、プロジェクト単位で動くフリーランス的な働き方が最も能力を発揮します。",
        "love": "【自由と知性】\n束縛されると窒息して逃げ出します。「どこで何してるの？」と聞かれるのが大嫌い。パートナーには、それぞれの時間を楽しみ、会った時には刺激的な会話ができるような、自立した大人の関係を求めます。",
        "fate_code": "Input(感覚)→Process(成長)→Output(衝動)→Drive(自我)\n直感で動き、走りながら考える。失敗しても「まあいいか、次！」と切り替える早さはピカイチ。",
        "desire": "【自由・流動】\n一箇所に留まらず、常に動き回っていること、自分の意志で選択できることを最重要視します。",
        "flaw_desc": "ふらっと消える音信不通の常習犯。責任や約束を重荷に感じ、大事な局面で逃亡することも。"
    },
    9: { # 癸
        "type_name": "No.10 癒やしの共感者（THE COUNSELOR）",
        "catch_copy": "静かに浸透する、\n慈愛の賢者",
        "desc": "あなたは雨のように静かに、しかし確実に大地（人の心）に染み渡る存在です。派手な自己主張はしませんが、驚くほどの知識と知恵を持っており、ここぞという時に核心を突くアドバイスをします。他人の痛みを自分のことのように感じる共感力の高さは、10タイプ中で随一です。",
        "work": "【研究・カウンセリング】\n競争が激しい環境や、ノルマに追われる仕事は消耗します。心理カウンセラー、研究職、図書館司書、秘書、占い師など、静かな環境でじっくりと物事や人と向き合う仕事。また、裏方として組織の知能中枢を担う役割も適しています。",
        "love": "【共感と献身】\n愛する人とは心も体も溶け合うような一体感を求めます。相手の色に染まることができ、献身的に尽くします。しかし、不満を溜め込みやすいため、ある日突然爆発するか、何も言わずに「サイレント・ブロック」をして関係を絶つことがあります。",
        "fate_code": "Input(論理)→Process(堅実)→Output(熟考)→Drive(協調)\n感情豊かでありながら、思考は非常に論理的。冷静と情熱の間を行き来する複雑な内面を持ちます。",
        "desire": "【共感・貢献】\n誰かの役に立っている実感と、感情を共有できる深い繋がりを求めます。",
...
def analyze_big5(scores_norm, fate_type_id):
    ...
    # 2. 宿命とのギャップ分析 (簡易ロジック)
    # 例: リーダータイプ(0)なのに外向性が低い場合など
    warnings = []
    
    # Type 0(甲), 2(丙), 6(庚) は本来「外向・主導」タイプ
    ...
    # Type 4(戊), 7(辛) は本来「堅実・こだわり」タイプ -> 勤勉性
